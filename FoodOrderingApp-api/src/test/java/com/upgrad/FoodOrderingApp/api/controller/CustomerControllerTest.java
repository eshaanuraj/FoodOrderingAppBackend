...
public class CustomerControllerTest {
    ...
    @MockBean
    private AuthenticationService mockCustomerAuthService;

    @MockBean
    private UpdateBusinessService mockCustomerUpdateService;
    ...
    public void shouldLoginForValidRequest() throws Exception {
        ...
        when(mockCustomerAuthService.signin("9090909090", "CorrectPassword"))
        ...
        verify(mockCustomerAuthService, times(1)).signin("9090909090", "CorrectPassword");
    }
    ...
    public void shouldNotLoginForInvalidAuthorizationFormat() throws Exception {
        ...
        verify(mockCustomerAuthService, times(0)).signin(anyString(), anyString());
    }
    ...
    public void shouldNotLoginIfNoDataPresentForGivenMobileNo() throws Exception {
        when(mockCustomerAuthService.signin("123", "CorrectPassword"))
        ...
        verify(mockCustomerAuthService, times(1)).signin("123", "CorrectPassword");
    }
    ...
    public void shouldNotLoginForWrongPassword() throws Exception {
        when(mockCustomerAuthService.signin("9090909090", "IncorrectPassword"))
        ...
        verify(mockCustomerAuthService, times(1)).signin("9090909090", "IncorrectPassword");
    }
    ...
    public void shouldLogoutForValidRequest() throws Exception {
        ...
        customerEntity.setUuid(customerId);
        createdCustomerAuthEntity.setCustomer(customerEntity);
        when(mockCustomerAuthService.logout("access-token")).thenReturn(createdCustomerAuthEntity);
        ...
        mockMvc
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("id").value(customerId));
        verify(mockCustomerAuthService, times(1)).logout("access-token");
    }
    ...
    public void shouldNotLogoutWhenCustomerIsNotLoggedIn() throws Exception {
        when(mockCustomerAuthService.logout("auth"))
        ...
        verify(mockCustomerAuthService, times(1)).logout("auth");
    }
    ...
    public void shouldUpdateCustomerDetails() throws Exception {
        ...
        when(mockCustomerUpdateService.getCustomer("auth")).thenReturn(customerEntity);
        ...
        when(mockCustomerUpdateService.updateCustomer(customerEntity)).thenReturn(updatedCustomerEntity);
        mockMvc
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("id").value(customerId));
        verify(mockCustomerUpdateService, times(1)).getCustomer("auth");
        verify(mockCustomerUpdateService, times(1)).updateCustomer(customerEntity);
    }
    ...
    public void shouldNotUpdateCustomerDetailsIfFirstNameNotPresentInTheRequest() throws Exception {
        ...
        verify(mockCustomerUpdateService, times(0)).getCustomer(anyString());
        verify(mockCustomerUpdateService, times(0)).updateCustomer(any());
    }
    ...
    public void shouldNotUpdateCustomerDetailsWhenCustomerIsNotLoggedIn() throws Exception {
        when(mockCustomerUpdateService.getCustomer("auth"))
                .thenThrow(new AuthorizationFailedException("ATHR-001", "Customer is not Logged in."));
    ...
    public void shouldUpdateCustomerPassword() throws Exception {
        ...
        when(mockCustomerUpdateService.getCustomer("auth")).thenReturn(customerEntity);
        when(mockCustomerUpdateService.updateCustomerPassword("oldPwd", "newPwd", customerEntity))
        ...
        mockMvc
                ...
                .andExpect(jsonPath("id").value(customerId));
        verify(mockCustomerUpdateService, times(1)).getCustomer("auth");
        verify(mockCustomerUpdateService, times(1)).updateCustomerPassword("oldPwd", "newPwd", customerEntity);
    }
